...
#import "HSAQRCodeScanView.h"

/** 扫描内容的 W 值 */
#define scanBorderW 0.65 * self.frame.size.width
/** 扫描内容的 x 值 */
#define scanBorderX 0.5 * (1 - 0.65) * self.frame.size.width
/** 扫描内容的 Y 值 */
#define scanBorderY 0.5 * (self.frame.size.height - scanBorderW)
@interface HSAQRCodeScanView ()
@property (nonatomic, strong) UIView *contentView;
@property (nonatomic, strong) NSTimer *timer;
@property (nonatomic, strong) UIImageView *scanningline;
@end

@implementation HSAQRCodeScanView
...
//        //获取bundle的路径
//        NSString *bundlePath = [[NSBundle mainBundle] pathForResource:@"HSAQRCode" ofType:@"bundle"];
//        //获取bundle
//        NSBundle *bundle = [NSBundle bundleWithPath:bundlePath];
//        NSLog(@"_________%@",self.scanImageName);
//        UIImage *image = [UIImage imageNamed:[bundle pathForResource:self.scanImageName ofType:@"png"]];
