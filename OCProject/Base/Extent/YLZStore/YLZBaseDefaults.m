...
@implementation YLZBaseDefaults
...
- (id<YLZBaseDefaultsStorable>)storage
{
    if ([self usingCustomDefaults]) {
        return (id<YLZBaseDefaultsStorable>)[[NSUserDefaults alloc] initWithSuiteName:[self customDefaultsName]];
    } else {
...
- (void)clear
{
    ...
    id<YLZBaseDefaultsStorable> storage = [self storage];
