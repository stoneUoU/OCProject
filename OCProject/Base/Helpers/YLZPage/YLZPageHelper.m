...
#import "YLZPageHelper.h"
#import <objc/runtime.h>
#import "YLZMediator.h"

@interface YLZPageHelper()
...
- (UIViewController *)currentViewController {
    return [YLZMediator topmostViewController];
}
...
- (UIViewController*)pushViewController:(NSString *)viewControllerName withParam:(NSDictionary *)param animated:(BOOL)animated
{
    ...
    UINavigationController *navigationController = [YLZMediator topmostNavigationController];
...
- (void)popThenPushViewController:(NSString *)viewControllerName withParam:(NSDictionary *)param animated:(BOOL)animated {
    UINavigationController *nav = [YLZMediator topmostNavigationController];
    if (!nav) {
        return;
    }
...
- (void)popToViewControllerThenPushViewController:(NSString *)popToViewControllerName
    ...
    UINavigationController *navController = [YLZMediator topmostNavigationController];
    if (!navController) {
        return ;
    }
...
@implementation NSArray (YLZPageHelper)
