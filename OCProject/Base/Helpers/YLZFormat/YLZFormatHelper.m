...
#import "YLZFormatHelper.h"

@implementation YLZFormatHelper
...
+ (NSDate *)strToDate:(NSString *)dateString withDateFormat:(NSString *)format
{
    ...
    return [YLZFormatHelper worldTimeToChina:date];
}
...
+ (NSString *)formatTimer:(NSString *)timeStr{
    NSDate * mydate = [YLZFormatHelper strToDate:timeStr withDateFormat:@"yyyy-MM-dd HH:mm:ss"];
    NSDateFormatter * dateFormatter = [[NSDateFormatter alloc] init];
