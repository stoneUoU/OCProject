...
- (void)viewDidLoad {
    ...
    [self setBaseUI:YLZColorWhite withTitleString:@"" withTitleColor:YLZColorTitleOne withLeftImageViewString:@"ylz_back_circle" withRightString:@"步骤1/2" withRightColor:YLZColorTitleThree withRightFontSize:14];
    [self setUI];
}
