...
- (void)viewDidLoad {
    ...
    [self setBaseUI:YLZColorWhite withTitleString:@"" withTitleColor:YLZColorTitleOne withLeftImageViewString:@"ylz_back" withRightString:@"步骤1/4" withRightColor:YLZColorTitleThree withRightFontSize:14];
    [self setUI];
}
