...
- (void)viewDidLoad {
    ...
    [self setBaseUI:YLZColorWhite withTitleString:@"" withTitleColor:YLZColorTitleOne withLeftImageViewString:@"ylz_back" withRightString:@"步骤2/2" withRightColor:YLZColorTitleThree withRightFontSize:14];
    [self setUI];
}
