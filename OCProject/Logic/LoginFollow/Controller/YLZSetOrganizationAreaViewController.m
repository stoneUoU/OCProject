//
//  YLZSetOrganizationAreaViewController.m
//  OCProject
//
...
@interface YLZSetOrganizationAreaViewController()<UITextFieldDelegate>
...
@implementation YLZSetOrganizationAreaViewController
...
- (void)viewDidLoad {
    ...
    [self setBaseUI:YLZColorWhite withTitleString:@"" withTitleColor:YLZColorTitleOne withLeftImageViewString:@"ylz_back_circle" withRightString:@"步骤2/2" withRightColor:YLZColorTitleThree withRightFontSize:14];
    [self setUI];
}
...
- (UILabel *)fontLabel {
    if (!_fontLabel) {
        ...
        _fontLabel.text = @"填写城市方便推荐更多同城好友";
