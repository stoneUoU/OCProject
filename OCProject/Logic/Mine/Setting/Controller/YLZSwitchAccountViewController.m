...
- (void)viewDidLoad {
    ...
    [self setBaseUI:YLZColorWhite withTitleString:@"切换账号" withTitleColor:YLZColorTitleOne withLeftImageViewString:@"ylz_back_circle" withRightString:@"" withRightColor:YLZColorWhite withRightFontSize:14];
    [self setUI];
}
